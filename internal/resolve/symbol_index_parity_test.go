...
func indexParityDiff(a, b Index) []string {
	...
	cmp("uncallableMember", a.uncallableMember, b.uncallableMember)
	cmp("eligibleMember", a.eligibleMember, b.eligibleMember)
	cmp("eligiblePackageMember", a.eligiblePackageMember, b.eligiblePackageMember)
