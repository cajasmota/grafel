...
// TestKotlinSmokeParse is the ABI guard for the vendored kotlin grammar. A
...
// window. This parses trivial Kotlin source (exercising the external scanner)
// through the official adapter and asserts a sane, non-error root.
func TestKotlinSmokeParse(t *testing.T) {
