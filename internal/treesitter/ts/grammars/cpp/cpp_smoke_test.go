...
func TestCppSmokeParse(t *testing.T) {
	...
	src := []byte("struct S { int f() { return 1; } };\n")
	...
	if root.ChildCount() == 0 {
		t.Fatal("root has no children (expected a struct_specifier)")
	}
}
