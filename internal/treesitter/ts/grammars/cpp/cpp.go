// Package cpp provides the C++ grammar via the official tree-sitter binding,
...
//
// ABI pin. The grammar is pinned to tree-sitter-cpp v0.23.4 against runtime
// v0.24.0 — its generated src/parser.c carries LANGUAGE_VERSION 14, inside the
// runtime's 13–14 window. v0.23.4 is already the latest upstream tag (no
...
func Language() ts.Language {
	return official.WrapLanguage(tsofficial.NewLanguage(tscpp.Language()))
}
