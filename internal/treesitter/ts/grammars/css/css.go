// Package css provides the CSS grammar via the official tree-sitter binding,
...
//
// ABI pin. The grammar is pinned to tree-sitter-css v0.23.2 against runtime
...
// Language returns the CSS grammar as a ts.Language bound to the official adapter.
func Language() ts.Language {
	return official.WrapLanguage(tsofficial.NewLanguage(tscss.Language()))
}
