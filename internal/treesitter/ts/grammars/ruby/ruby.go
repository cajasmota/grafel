// Package ruby provides the Ruby grammar via the official tree-sitter binding,
...
//
// ABI pin. The grammar is pinned to tree-sitter-ruby v0.23.1 against runtime
// v0.24.0 — its generated src/parser.c carries LANGUAGE_VERSION 14, inside the
// runtime's 13–14 window. v0.23.1 is already the latest upstream tag (no
...
// Language returns the Ruby grammar as a ts.Language bound to the official adapter.
func Language() ts.Language {
	return official.WrapLanguage(tsofficial.NewLanguage(tsruby.Language()))
}
