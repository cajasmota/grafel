...
var wantToolParams = map[string]string{
	...
	"grafel_cross_links":                 "action,cwd,group|req:action",
	...
	"grafel_endpoints":                   "action,cwd,effect,format,group,include_navigation,kind,limit,method,offset,orphan_only,path_contains,ref,repo_filter,token_budget|req:action",
	...
	"grafel_find":                        "context_filter,cross_repo,cwd,depth,fields,full,group,include_noise,min_confidence,mode,query,ref,repo_filter,token_budget|req:query",
	...
	"grafel_get_source":                  "context_lines,cwd,entity_id,from_line,group,to_line|req:entity_id",
	"grafel_graph_patterns":              "action,confidence_min,cwd,group,limit,needs_attention,pattern_id,repo_filter,status|req:action",
	"grafel_impact_radius":               "cwd,entity_id,group,hops,ref|req:entity_id",
	...
	"grafel_orient":                      "cwd,group,max_questions,repo_filter,top_edges,top_entities|req:",
	...
	"grafel_subgraph":                    "cwd,depth,entity_id,format,group,max_nodes|req:entity_id",
	...
	"grafel_trace":                       "cwd,group,ref,repo_filter,source,target|req:source,target",
