...
import { type TimelineConfigInterface } from './config';
import { DisplayStateManager } from '../_abstract/display-state-manager';
/**
 * A timeline component that shows data distribution over time or numeric range.
 * It provides an interface for selecting a range within the data.
 */
export declare class Timeline extends DisplayStateManager {
    private _config;
    ...
    private _checkFormatter;
    private _parseData;
    setTimeData(data: number[] | Date[] | undefined, customExtent?: [number, number] | [Date, Date]): void;
    setHighlightedData(data: number[] | Date[] | undefined): void;
    ...
    private _normalizeTimeToMilliseconds;
    destroy: () => void;
}
