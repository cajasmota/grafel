...
| flask-realworld | python | 43 | 7.60% (2026-05-19, python-django-w4; was 13.81%) | python-django-w4 | django/DRF/flask/SQLA framework base-class allowlist for EXTENDS structural-refs + Wave-4 pythonBareNames + knownExternalPackages (flask_sqlalchemy/flask_jwt_extended/pymongo/psycopg2/...) + super.X dynamic regex. Residual: SQLA `Query.first()` collision-blocked, generic verbs, dotted-receiver class member access | at-bar | dotted-receiver class member binding + #525 EXTENDS kind-disambiguator (in flight) |
| click | python | 138 | 6.45% (2026-05-19, python-django-w4; was 6.86%) | python-django-w4 | shared cumulative wins | at-bar | next python wave for ship-gate gap |
| django-realworld | python | 48 | 7.83% (2026-05-19, python-django-w4; was 13.11%) | python-django-w4 | django/DRF framework base-class allowlist + Wave-4 pythonBareNames + super.X dynamic regex + bare-kind-prefixed lang="" fallback. Residual: DRF ViewSet attribute access (#526), Django URLConf binder (#527), generic verbs (#529) | at-bar | #525 EXTENDS disambiguator (in flight, -3.4pp), #526 DRF ViewSet, #527 URLConf, #529 stragglers — path to ~1.8% |
| pandas | python | 197 | 10.11% (2026-05-19, python-django-w4; was 13.85%) | python-django-w4 | numpy/pandas bare-names | structural | further pandas wave needed |
| upvate_core | python (Django backend, user-provided) | 4202 | 13.56% (2026-05-19, post-#507+#521; was 13.70% pre-fixes) | #507 (psycopg2 dataaccess) + #521 (python wave-4 cumulative) — measured delta: bug-extractor 3617 → 3572 (-45), bug-resolver 668 → 630 (-38). Chain-fixes #531 (external-sql disposition bucket), #532 (db:&lt;table&gt; entity synthesis) | structural | Bulk of residual is python bare-other CALLS — addressable via #525 + Mongo/Celery follow-up |
