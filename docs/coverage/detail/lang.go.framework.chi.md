...
| Route extraction | 🟢 `partial` | `2026-05-29` | backfill:dictionary-completeness | `internal/custom/golang/chi.go`<br>`internal/engine/go_routes.go`<br>`internal/engine/rules/go/frameworks/chi.yaml` | — |
