...
|------------|--------|-------------|-------|-------|-------|
| Endpoint synthesis | ⚠️ `partial` | `2026-05-28` | — | `internal/engine/rules/elixir/frameworks/ash_framework.yaml` | — |
| Handler attribution | ⚠️ `partial` | `2026-05-28` | — | `internal/engine/rules/elixir/frameworks/ash_framework.yaml` | — |
