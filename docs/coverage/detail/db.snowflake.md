...
| Resource extraction | 🟢 `partial` | `2026-06-02` | 3828 | `internal/engine/orm_queries_datastore_infra.go` | Snowflake cursor.execute/query("... FROM table") (snowflake-connector-python, SQLAlchemy snowflake:// dialect, gosnowflake, JDBC; gated on snowflake / snowflake:// / snowflakecomputing.com) parses the SQL table into a Class:<Table> resource node + QUERIES dependency edge from the connecting function (emitSnowflakeTargets, mirrors emitCQLTargets). Tableless/runtime SQL honest-skipped. |
