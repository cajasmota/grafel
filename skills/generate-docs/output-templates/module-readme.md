...
> If `list_enrichment_candidates` returned anything blocking accurate documentation of this module, list it here. Each item: candidate id, what is unknown, what would unblock it.
